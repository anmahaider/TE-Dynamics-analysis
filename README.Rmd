...
-   A copy is identified as at least 0.5 sequence coverage and 0.8 sequence identity in long read assembly analysis.
-   Only TE sequences longer than 500 bp are considered during the analysis
...
4.  Upload the data `merged.clean.sum` to the folder "data/distributions" specifying the species. Add some metadata to the Google Sheet file.
